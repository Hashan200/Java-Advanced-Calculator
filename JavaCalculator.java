...
public class JavaCalculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        decimal.setFont(new java.awt.Font("Tahoma", 1, 14));
        decimal.setText(".");
        ...
        plus.setFont(new java.awt.Font("Tahoma", 1, 14)); 
        plus.setText("+");
        ...
        multiply.setFont(new java.awt.Font("Tahoma", 1, 14));
        multiply.setText("*");
        ...
        divide.setFont(new java.awt.Font("Tahoma", 1, 14)); 
        divide.setText("/");
        ...
        posneg.setFont(new java.awt.Font("Tahoma", 1, 14)); 
        posneg.setText("+/-");
        ...
        equals.setFont(new java.awt.Font("Tahoma", 1, 14)); 
        equals.setText("=");
        ...
        Button9.setFont(new java.awt.Font("Tahoma", 1, 14)); 
        Button9.setText("9");
